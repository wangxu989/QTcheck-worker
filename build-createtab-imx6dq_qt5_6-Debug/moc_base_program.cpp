/****************************************************************************
** Meta object code from reading C++ file 'base_program.h'
**
...
#include "../createtab/base_program.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'base_program.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 24, 8) // "QWidget*"
    ...
    "MyWidget\0change_widget\0\0QWidget*"
};
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyWidget::*_t)(QWidget * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::change_widget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyWidget::change_widget(QWidget * _t1)
{
