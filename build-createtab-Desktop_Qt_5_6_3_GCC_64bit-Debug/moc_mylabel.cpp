...
QT_MOC_LITERAL(3, 17, 8) // "MyLabel*"

    },
    "MyLabel\0clicked\0\0MyLabel*"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< MyLabel*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyLabel::*_t)(MyLabel * );
